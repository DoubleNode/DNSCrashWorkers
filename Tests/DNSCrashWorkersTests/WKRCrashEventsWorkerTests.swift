//
//  WKRCrashEventsWorkerTests.swift
...
final class WKRCrashEventsWorkerTests: XCTestCase {
    var sut: WKRCrashEvents!
    ...
    func test_init_succeeds() {
        // Given & When
        let worker = WKRCrashEvents()

        // Then
        XCTAssertNotNil(worker)
        XCTAssertTrue(worker is WKRCrashEvents)
    }
