//
//  WKRCrashBeaconDistWorkerTests.swift
...
final class WKRCrashBeaconDistWorkerTests: XCTestCase {
    ...
    func test_init_succeeds() {
        // Given & When
        let worker = WKRCrashBeaconDist()

        // Then
        XCTAssertNotNil(worker)
        XCTAssertTrue(worker is WKRCrashBeaconDist)
    }
    ...
    func test_inheritsFromBlankWorker() {
        // Given & When
        let isBlankWorker = sut is WKRBlankBeaconDist
