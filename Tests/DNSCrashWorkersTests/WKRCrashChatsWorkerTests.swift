//
//  WKRCrashChatsWorkerTests.swift
...
final class WKRCrashChatsWorkerTests: XCTestCase {
    var sut: WKRCrashChats!
    ...
    func test_init_succeeds() {
        // Given & When
        let worker = WKRCrashChats()

        // Then
        XCTAssertNotNil(worker)
        XCTAssertTrue(worker is WKRCrashChats)
    }
    ...
    func test_inheritsFromBlankWorker() {
        // Given & When
        let isBlankWorker = sut is WKRBlankChats
