//
//  WKRCrashPassportsWorkerTests.swift
...
final class WKRCrashPassportsWorkerTests: XCTestCase {
    ...
    func test_init_succeeds() {
        // Given & When
        let worker = WKRCrashPassports()

        // Then
        XCTAssertNotNil(worker)
        XCTAssertTrue(worker is WKRCrashPassports)
    }
    ...
    func test_inheritsFromBlankWorker() {
        // Given & When
        let isBlankWorker = sut is WKRBlankPassports
