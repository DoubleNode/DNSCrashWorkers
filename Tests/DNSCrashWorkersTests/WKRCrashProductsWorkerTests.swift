//
//  WKRCrashProductsWorkerTests.swift
...
final class WKRCrashProductsWorkerTests: XCTestCase {
    ...
    func test_init_succeeds() {
        // Given & When
        let worker = WKRCrashProducts()

        // Then
        XCTAssertNotNil(worker)
        XCTAssertTrue(worker is WKRCrashProducts)
    }
    ...
    func test_inheritsFromBlankWorker() {
        // Given & When
        let isBlankWorker = sut is WKRBlankProducts
