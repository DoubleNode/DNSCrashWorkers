//
//  WKRCrashPlacesWorkerTests.swift
...
final class WKRCrashPlacesWorkerTests: XCTestCase {
    var sut: WKRCrashPlaces!
    ...
    func test_init_succeeds() {
        // Given & When
        let worker = WKRCrashPlaces()

        // Then
        XCTAssertNotNil(worker)
        XCTAssertTrue(worker is WKRCrashPlaces)
    }
    ...
    func test_inheritsFromBlankWorker() {
        // Given & When
        let isBlankWorker = sut is WKRBlankPlaces
