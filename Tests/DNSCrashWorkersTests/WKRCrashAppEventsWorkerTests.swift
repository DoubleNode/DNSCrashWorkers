//
//  WKRCrashAppEventsWorkerTests.swift
...
final class WKRCrashAppEventsWorkerTests: XCTestCase {
    ...
    func test_init_succeeds() {
        // Given & When
        let worker = WKRCrashAppEvents()

        // Then
        XCTAssertNotNil(worker)
        XCTAssertTrue(worker is WKRCrashAppEvents)
    }
    ...
    func test_inheritsFromBlankWorker() {
        // Given & When
        let isBlankWorker = sut is WKRBlankAppEvents
