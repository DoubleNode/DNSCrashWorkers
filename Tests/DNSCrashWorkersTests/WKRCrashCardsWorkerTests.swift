//
//  WKRCrashCardsWorkerTests.swift
...
final class WKRCrashCardsWorkerTests: XCTestCase {
    var sut: WKRCrashCards!
    ...
    func test_init_succeeds() {
        // Given & When
        let worker = WKRCrashCards()

        // Then
        XCTAssertNotNil(worker)
        XCTAssertTrue(worker is WKRCrashCards)
    }
    ...
    func test_inheritsFromBlankWorker() {
        // Given & When
        let isBlankWorker = sut is WKRBlankCards
