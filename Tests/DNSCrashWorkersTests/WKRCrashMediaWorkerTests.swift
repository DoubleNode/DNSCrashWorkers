//
//  WKRCrashMediaWorkerTests.swift
...
final class WKRCrashMediaWorkerTests: XCTestCase {
    var sut: WKRCrashMedia!
    ...
    func test_init_succeeds() {
        // Given & When
        let worker = WKRCrashMedia()

        // Then
        XCTAssertNotNil(worker)
        XCTAssertTrue(worker is WKRCrashMedia)
    }
    ...
    func test_inheritsFromBlankWorker() {
        // Given & When
        let isBlankWorker = sut is WKRBlankMedia
