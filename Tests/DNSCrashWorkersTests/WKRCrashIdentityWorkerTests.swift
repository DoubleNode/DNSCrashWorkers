//
//  WKRCrashIdentityWorkerTests.swift
...
final class WKRCrashIdentityWorkerTests: XCTestCase {
    ...
    func test_init_succeeds() {
        // Given & When
        let worker = WKRCrashIdentity()

        // Then
        XCTAssertNotNil(worker)
        XCTAssertTrue(worker is WKRCrashIdentity)
    }
    ...
    func test_inheritsFromBlankWorker() {
        // Given & When
        let isBlankWorker = sut is WKRBlankIdentity
