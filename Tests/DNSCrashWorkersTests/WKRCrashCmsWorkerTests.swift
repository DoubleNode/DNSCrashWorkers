...
final class WKRCrashCmsWorkerTests: XCTestCase {
    var sut: WKRCrashCms!
    ...
    func test_init_succeeds() {
        // Given & When
        let worker = WKRCrashCms()

        // Then
        XCTAssertNotNil(worker)
        XCTAssertTrue(worker is WKRCrashCms)
    }
    ...
    func test_inheritsFromBlankWorker() {
        // Given & When
        let isBlankWorker = sut is WKRBlankCms
