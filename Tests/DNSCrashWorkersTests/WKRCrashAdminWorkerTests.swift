//
//  WKRCrashAdminWorkerTests.swift
...
final class WKRCrashAdminWorkerTests: XCTestCase {
    var sut: WKRCrashAdmin!
    ...
    func test_init_succeeds() {
        // Given & When
        let worker = WKRCrashAdmin()

        // Then
        XCTAssertNotNil(worker)
        XCTAssertTrue(worker is WKRCrashAdmin)
    }
    ...
    func test_inheritsFromBlankWorker() {
        // Given & When
        let isBlankWorker = sut is WKRBlankAdmin
