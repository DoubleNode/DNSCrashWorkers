//
//  WKRCrashPricingWorkerTests.swift
...
final class WKRCrashPricingWorkerTests: XCTestCase {
    var sut: WKRCrashPricing!
    ...
    func test_init_succeeds() {
        // Given & When
        let worker = WKRCrashPricing()

        // Then
        XCTAssertNotNil(worker)
        XCTAssertTrue(worker is WKRCrashPricing)
    }
    ...
    func test_inheritsFromBlankWorker() {
        // Given & When
        let isBlankWorker = sut is WKRBlankPricing
