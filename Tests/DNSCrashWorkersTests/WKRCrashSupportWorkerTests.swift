//
//  WKRCrashSupportWorkerTests.swift
...
final class WKRCrashSupportWorkerTests: XCTestCase {
    var sut: WKRCrashSupport!
    ...
    func test_init_succeeds() {
        // Given & When
        let worker = WKRCrashSupport()

        // Then
        XCTAssertNotNil(worker)
        XCTAssertTrue(worker is WKRCrashSupport)
    }
    ...
    func test_inheritsFromBlankWorker() {
        // Given & When
        let isBlankWorker = sut is WKRBlankSupport
