//
//  WKRCrashAppReivewWorkerTests.swift
...
final class WKRCrashAppReivewWorkerTests: XCTestCase {
    ...
    func test_inheritsFromBlankWorker() {
        // Given & When
        let isBlankWorker = sut is WKRBlankAppReview
