//
//  WKRCrashSectionsWorkerTests.swift
...
final class WKRCrashSectionsWorkerTests: XCTestCase {
    ...
    func test_init_succeeds() {
        // Given & When
        let worker = WKRCrashSections()

        // Then
        XCTAssertNotNil(worker)
        XCTAssertTrue(worker is WKRCrashSections)
    }
    ...
    func test_inheritsFromBlankWorker() {
        // Given & When
        let isBlankWorker = sut is WKRBlankSections
