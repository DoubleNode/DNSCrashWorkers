//
//  WKRCrashPromotionsWorkerTests.swift
...
final class WKRCrashPromotionsWorkerTests: XCTestCase {
    ...
    func test_init_succeeds() {
        // Given & When
        let worker = WKRCrashPromotions()

        // Then
        XCTAssertNotNil(worker)
        XCTAssertTrue(worker is WKRCrashPromotions)
    }
    ...
    func test_inheritsFromBlankWorker() {
        // Given & When
        let isBlankWorker = sut is WKRBlankPromotions
