//
//  WKRCrashPermissionsWorkerTests.swift
...
final class WKRCrashPermissionsWorkerTests: XCTestCase {
    ...
    func test_init_succeeds() {
        // Given & When
        let worker = WKRCrashPermissions()

        // Then
        XCTAssertNotNil(worker)
        XCTAssertTrue(worker is WKRCrashPermissions)
    }
    ...
    func test_inheritsFromBlankWorker() {
        // Given & When
        let isBlankWorker = sut is WKRBlankPermissions
